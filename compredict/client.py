...
class api:
    ...
    def run_algorithm(self,
        ...
        :param callback_url: The callback url that will override the callback url in the class.
                             ...
                             url. In this case list of dictionaries is required. If single
                             callback dictionary is passed with list of callback urls - then the
                             same parameters will be used with all callback urls.
